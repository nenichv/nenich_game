...
namespace superagent
{
    public class EndOfGame
    {
        ...
        private readonly SpriteFont TextEnd;
        ...
        public void Draw(World world)
        {
            ...
            else GeneralVariable.SpriteBatch.DrawString(TextEnd, "Ты проиграл! Нажми Escape, чтобы выйти из игры.", new Vector2(50, 250), Color.WhiteSmoke);
        }
    }
}
